...
// console.log(`It will take the ${spacecraftName} spacecraft ${daysToMars} days to reach Mars.`);
...
// console.log(`It will take the ${spacecraftName} spacecraft ${getDaysToLocation(kilometersToTheMoon)} days to reach the Moon.`);
